  ...
  return (
    <div className="fade-up">
      <div className="page-hdr">
        ...
        <Link to="/patients/new" className="btn btn-primary">+ Добавить</Link>
      </div>
      ...
      {filtered.length === 0 ? (
        <div className="empty-state">
          ...
          <Link to="/patients/new" className="btn btn-primary">+ Добавить пациента</Link>
        </div>
      ) : view === 'grid' ? (
        <GridView patients={filtered} />
      ) : (
        <TableView patients={filtered} onSort={toggleSort} sortBy={sortBy} sortDir={sortDir} />
      )}
    </div>
  );
}
...
/* ── Table view ────────────────────────────────────── */
function TableView({ patients, onSort, sortBy, sortDir }) {
                ...
                <tr key={p.id}>
                  ...
                  <td>
                    <div className="td-actions">
                      ...
                      <Link to={`/patients/${p.id}/edit`}  className="btn btn-sm btn-ghost">Изменить</Link>
                    </div>
                  </td>
                </tr>
              );
